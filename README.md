...
Then, the program applies the Low-Pass Filter. Using the Z-Transform on the Transfer Function of the filter with the values of RLC (Resistance, Inductance and Capacitance).
